...
public class FX_Input_Mgr : MonoBehaviour {
	...
	*/
    ...
    public bool EnableSubComponents = true;
    ...
    public KeyCode ZoomNormal = KeyCode.Keypad0;
    public KeyCode ZoomIn = KeyCode.KeypadPlus;
    public KeyCode ZoomOut = KeyCode.KeypadMinus;
	
	public _keyMod Switch3D2DKM;
	public _keyMod ToggleIndicatorsKM;
    public _keyMod ZoomNormalKM;
    public _keyMod ZoomInKM;
    public _keyMod ZoomOutKM;
